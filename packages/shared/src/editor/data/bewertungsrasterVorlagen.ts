 ...
 * 12 Vorlagen: 5 fachuebergreifend + 4 WR-spezifisch + 3 andere Fachschaften.
 * Punkte sind Beispiel-Werte -- werden beim Laden auf die tatsaechlichen
...
export interface BewertungsrasterVorlage {
  ...
  fachbereiche: Fachbereich[]  // leer = fuer alle Faecher geeignet
  fragetypen: string[]         // fuer welche Fragetypen passend
  ...
  kriterien: [
    {
      ...
      punkte: 2,
      niveaustufen: [
        { punkte: 2, beschreibung: 'Inhaltlich vollstaendig und korrekt' },
    ...
    {
      beschreibung: 'Praezision der Formulierung',
      punkte: 1,
      niveaustufen: [
        { punkte: 1, beschreibung: 'Fachbegriffe korrekt verwendet, praezise formuliert' },
        { punkte: 0.5, beschreibung: 'Umgangssprache statt Fachsprache, aber verstaendlich' },
        { punkte: 0, beschreibung: 'Unklar oder unverstaendlich formuliert' },
      ],
    },
  ],
}
...
const freitextLang: BewertungsrasterVorlage = {
  id: '__freitext_lang',
  name: 'Freitext Lang (Eroerterung)',
  kategorie: 'fachuebergreifend',
  fachbereiche: [],
  fragetypen: ['freitext'],
  builtin: true,
  kriterien: [
    {
      ...
      punkte: 2,
      niveaustufen: [
        { punkte: 2, beschreibung: 'Schluessige Argumentation mit mehreren Belegen/Beispielen' },
        { punkte: 1, beschreibung: 'Nachvollziehbare Argumentation, einzelne Belege' },
        { punkte: 0, beschreibung: 'Keine erkennbare oder widerspruchliche Argumentation' },
      ],
    },
    {
      ...
      niveaustufen: [
        ...
        { punkte: 1, beschreibung: 'Einzelne Fachbegriffe, teilweise unpraezis' },
        { punkte: 0, beschreibung: 'Keine Fachbegriffe oder falsch verwendet' },
      ],
    },
    {
      beschreibung: 'Vollstaendigkeit',
      punkte: 1,
      niveaustufen: [
        { punkte: 1, beschreibung: 'Alle relevanten Aspekte beruecksichtigt' },
  ...
  kriterien: [
    {
      ...
      punkte: 2,
      niveaustufen: [
        { punkte: 2, beschreibung: 'Material systematisch ausgewertet, konkrete Bezuege hergestellt' },
        { punkte: 1, beschreibung: 'Material teilweise einbezogen, einzelne Bezuege' },
    ...
    },
    {
      ...
      niveaustufen: [
        ...
        { punkte: 1, beschreibung: 'Fachkonzepte benannt, Anwendung lueckenhaft' },
    ...
    },
    {
      ...
      punkte: 1,
      niveaustufen: [
        { punkte: 1, beschreibung: 'Begruendete Schlussfolgerung, logisch aus Analyse abgeleitet' },
        { punkte: 0.5, beschreibung: 'Schlussfolgerung vorhanden, aber nicht schluessig begruendet' },
        { punkte: 0, beschreibung: 'Keine Schlussfolgerung oder unbegruendet' },
      ],
    },
    {
      beschreibung: 'Eigenstaendigkeit',
      punkte: 1,
      niveaustufen: [
        { punkte: 1, beschreibung: 'Eigene Ueberlegungen erkennbar, ueber Reproduktion hinaus' },
        { punkte: 0.5, beschreibung: 'Ansaetze eigenstaendigen Denkens' },
...
const berechnungErklaerung: BewertungsrasterVorlage = {
  ...
  name: 'Berechnung mit Erklaerung',
  kategorie: 'fachuebergreifend',
  fachbereiche: [],
  ...
  kriterien: [
    {
      beschreibung: 'Loesungsweg / Rechenweg',
      punkte: 2,
      niveaustufen: [
        { punkte: 2, beschreibung: 'Rechenweg vollstaendig und nachvollziehbar dargestellt' },
        { punkte: 1, beschreibung: 'Rechenweg erkennbar, aber lueckenhaft oder unklar' },
        { punkte: 0, beschreibung: 'Kein Rechenweg oder unverstaendlich' },
      ],
    },
    {
    ...
    {
      beschreibung: 'Erklaerung / Interpretation',
      punkte: 0.5,
      niveaustufen: [
...
const grafikInterpretation: BewertungsrasterVorlage = {
  ...
  kriterien: [
    ...
    {
      beschreibung: 'Ursachenerklaerung',
      punkte: 2,
      niveaustufen: [
        { punkte: 2, beschreibung: 'Ursachen fachlich fundiert und differenziert erklaert' },
        { punkte: 1, beschreibung: 'Ursachen benannt, aber oberflaechlich' },
        { punkte: 0, beschreibung: 'Keine Ursachenerklaerung' },
      ],
    },
    {
      ...
      punkte: 1,
      niveaustufen: [
        { punkte: 1, beschreibung: 'Begruendete Schlussfolgerung oder Prognose aus den Daten' },
        { punkte: 0.5, beschreibung: 'Ansatz einer Schlussfolgerung ohne klare Begruendung' },
...
const rechtsfallanalyse: BewertungsrasterVorlage = {
  ...
  kriterien: [
    ...
    },
    {
      ...
      punkte: 1,
      niveaustufen: [
        { punkte: 1, beschreibung: 'Sachverhalt schluessig unter Norm subsumiert' },
        { punkte: 0.5, beschreibung: 'Subsumtion erkennbar, aber lueckenhaft oder unpraezis' },
...
const vwlModellanalyse: BewertungsrasterVorlage = {
  ...
  kriterien: [
    {
      beschreibung: 'Modellverstaendnis',
      punkte: 1,
      niveaustufen: [
    ...
    },
    {
      ...
      punkte: 1,
      niveaustufen: [
        { punkte: 1, beschreibung: 'Kausalkette vollstaendig: Ursache -> Modellmechanismus -> Wirkung' },
        { punkte: 0.5, beschreibung: 'Wirkungskette angedeutet, aber Luecken in der Kausalitaet' },
    ...
    },
    {
      ...
      punkte: 1,
      niveaustufen: [
        { punkte: 1, beschreibung: 'Modell kritisch auf Realitaet uebertragen, Grenzen reflektiert' },
  ...
  kriterien: [
    {
      ...
      niveaustufen: [
        ...
        { punkte: 0.5, beschreibung: 'Einige Kriterien benannt, aber unvollstaendig oder ungewichtet' },
    ...
    },
    {
      ...
      niveaustufen: [
        ...
        { punkte: 1, beschreibung: 'Vergleich vorhanden, aber nicht systematisch oder unvollstaendig' },
        { punkte: 0, beschreibung: 'Kein Vergleich der Alternativen' },
      ],
    },
    {
      beschreibung: 'Begruendete Empfehlung',
      punkte: 1,
      niveaustufen: [
        { punkte: 1, beschreibung: 'Klare Empfehlung mit Bezug auf die Analyse' },
        { punkte: 0.5, beschreibung: 'Empfehlung vorhanden, aber schwach begruendet' },
...
const fibuBegruendung: BewertungsrasterVorlage = {
  ...
  name: 'Buchhalterische Begruendung',
  kategorie: 'BWL',
  fachbereiche: ['BWL'],
  fragetypen: ['freitext'],
  builtin: true,
  kriterien: [
    {
      beschreibung: 'Konto-Wahl begruendet',
      punkte: 1,
      niveaustufen: [
        { punkte: 1, beschreibung: 'Konten korrekt benannt und Wahl fachlich begruendet' },
        { punkte: 0.5, beschreibung: 'Konten genannt, Begruendung fehlt oder ist falsch' },
    ...
    },
    {
      ...
      punkte: 1,
      niveaustufen: [
        { punkte: 1, beschreibung: 'Soll/Haben-Logik korrekt erklaert (Zunahme/Abnahme)' },
        { punkte: 0.5, beschreibung: 'Soll/Haben teilweise korrekt' },
        { punkte: 0, beschreibung: 'Soll/Haben falsch oder nicht erklaert' },
      ],
    },
    {
      beschreibung: 'Buchungslogik erklaert',
      punkte: 1,
      niveaustufen: [
        { punkte: 1, beschreibung: 'Geschaeftsvorfall korrekt in Buchungslogik uebersetzt' },
        { punkte: 0.5, beschreibung: 'Ansatz erkennbar, aber Logik lueckenhaft' },
...
const textproduktion: BewertungsrasterVorlage = {
  ...
  kriterien: [
    ...
    },
    {
      ...
      punkte: 2,
      niveaustufen: [
        { punkte: 2, beschreibung: 'Differenzierter Wortschatz, wenige Fehler, fluessig lesbar' },
        { punkte: 1, beschreibung: 'Verstaendlich, einfacher Wortschatz, einige Fehler' },
        { punkte: 0, beschreibung: 'Viele Fehler, schwer verstaendlich' },
      ],
    },
    {
...
const quellenanalyse: BewertungsrasterVorlage = {
  ...
  kriterien: [
    ...
    },
    {
      ...
      punkte: 1,
      niveaustufen: [
        { punkte: 1, beschreibung: 'Quelle in historischen Zusammenhang eingebettet, Bezuege hergestellt' },
        { punkte: 0.5, beschreibung: 'Kontextwissen vorhanden, aber nicht mit Quelle verknuepft' },
    ...
    },
    {
      ...
      punkte: 1,
      niveaustufen: [
        { punkte: 1, beschreibung: 'Quellenkritik: Perspektivitaet, Zuverlaessigkeit, Erkenntnisgewinn reflektiert' },
  ...
  kriterien: [
    {
      ...
      punkte: 1,
      niveaustufen: [
        { punkte: 1, beschreibung: 'Klare, ueberpruefbare Hypothese mit Begruendung formuliert' },
        { punkte: 0.5, beschreibung: 'Hypothese vorhanden, aber vage oder nicht ueberpruefbar' },
    ...
    },
    {
      ...
      niveaustufen: [
        ...
        { punkte: 0.5, beschreibung: 'Methode erkennbar, aber lueckenhaft' },
    ...
    },
    {
      ...
      punkte: 1,
      niveaustufen: [
        { punkte: 1, beschreibung: 'Beobachtungen praezis dokumentiert, Messwerte mit Einheiten' },
        { punkte: 0.5, beschreibung: 'Beobachtungen vorhanden, aber unpraezis oder unvollstaendig' },
 ...
 * Gibt fachuebergreifende + fachspezifische Vorlagen zurueck.
 */
