...
export interface AnhangEditorProps {
  ...
  /** Optionale AudioRecorder-Komponente (Host-spezifisch) */
  AudioRecorderComponent?: React.ComponentType<{
...
export default function AnhangEditor({
  ...
  return (
    <Abschnitt titel="Anhänge" einklappbar standardOffen={false}>
      ...
      {/* Audio-Aufnahme (nur wenn AudioRecorder verfügbar) */}
      {zeigAufnahme && AudioRecorderComponent && (
