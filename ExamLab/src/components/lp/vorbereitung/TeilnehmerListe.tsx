        ...
        {gefilterteGruppen.map(({ klasse, schueler }) => {
          ...
          return (
            <div key={klasse}>
              ...
              >
                <span className="text-[10px] text-slate-400 dark:text-slate-500 transition-transform duration-150" style={{ transform: istZu ? 'rotate(0deg)' : 'rotate(90deg)', display: 'inline-block' }}>
                  ▶
                </span>
