...
import type { Frage, MCFrage, RichtigFalschFrage, LueckentextFrage, ZuordnungFrage, BerechnungFrage, KontenbestimmungFrage, FrageAnhang, HotspotFrage, BildbeschriftungFrage, DragDropBildFrage } from '../../../types/fragen'
