  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900">
      <header className="bg-white dark:bg-slate-800 shadow-sm px-6 py-4">
        <h1 className={`${TYPO.h2} text-slate-800 dark:text-slate-100`}>Admin-Dashboard</h1>
        <span className="text-sm text-slate-500">{aktiveGruppe?.name}</span>
      </header>

      <main className="max-w-4xl mx-auto p-6">
        <h2 className={`${TYPO.h1} text-slate-800 dark:text-slate-100 mb-4`}>Gruppe verwalten</h2>
