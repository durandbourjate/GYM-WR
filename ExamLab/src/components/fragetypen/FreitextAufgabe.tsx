...
/**
 * Tiptap-basierter SuS-Eingabe-Editor für Freitext-Fragen.
 *
 * Bewusst in einer eigenen Datei (statt in FreitextFrage.tsx), damit
 * FreitextFrage.tsx diese Komponente via `lazyMitRetry()` als eigenen
 * async-Chunk laden kann. So landet @tiptap (~40-70 kB) NICHT mehr
 * synchron im Layout-Chunk (SuS-Prüfungsdurchführung), sondern wird erst
 * geladen, wenn tatsächlich eine Freitext-Aufgabe gerendert wird.
 * Der Lösungs-/Korrektur-Pfad (FreitextLoesung) nutzt kein tiptap und
 * bleibt synchron in FreitextFrage.tsx.
 */
...
export default function FreitextAufgabe({ frage }: { frage: FreitextFrageType }) {
