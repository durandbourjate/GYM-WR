...
type HilfeKategorie = 'einstieg' | 'pruefung' | 'fragen' | 'ki' | 'durchfuehrung' | 'korrektur' | 'faq'
...
function HilfeEinstieg() {
  return (
    <div>
      ...
      <Text>
        Ohne Backend-Konfiguration läuft die App im Demo-Modus mit Beispieldaten. Sie können alle Funktionen ausprobieren — Änderungen werden aber nicht gespeichert.
      </Text>
    </div>
  )
}
